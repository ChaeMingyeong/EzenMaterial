 ...
 * Generated at: 2019-08-09 05:53:20 UTC
...
public final class exam01_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t// 전달된 xml 데이터에서 값 추출\r\n");
      out.write("\t\t\tvar title = $(data).find(\"title\").text();\r\n");
      out.write("\t\t\tvar time = $(data).find(\"time\").text();\r\n");
      out.write("\t\t\tvar teacher = $(data).find(\"teacher\").text();\r\n");
      out.write("\t\t\t//추출된 데이터를 화면에 출력하기 위해, HTML 요소를 동적으로 생성\r\n");
      out.write("\t\t\tvar div = $(\"<div>\");\r\n");
      out.write("\t\t\tvar p1 = $(\"<p>\").html(title);\r\n");
      out.write("\t\t\tvar p2 = $(\"<p>\").html(time);\r\n");
      out.write("\t\t\tvar p3 = $(\"<p>\").html(teacher);\r\n");
      out.write("\t\t\t//메소드 체인을 사용한 동적요소의 결합\r\n");
      ...
      out.write("          $(\"#result\").html(\"에러코드:\" + xhr.status);\r\n");
      out.write("        }\r\n");
      out.write("      });\r\n");
      out.write("    });\r\n");
      out.write("  });\r\n");
