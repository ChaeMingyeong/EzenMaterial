 ...
 * Generated at: 2019-07-26 09:10:59 UTC
...
public final class goods_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("goods.DTO.GoodsDTO");
    _jspx_imports_classes.add("java.util.List");
    _jspx_imports_classes.add("org.json.JSONObject");
    _jspx_imports_classes.add("goods.DAO.GoodsDAO");
	   ...
	   //JSON
		...
		if (total > 0) {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				temp.put("name", list.get(i).getCode());
				temp.put("price", list.get(i).getCode());
				temp.put("maker", list.get(i).getCode());		
       			// json 배열에  추가
				item.put(i, temp);
			}
			json.put("item", item);
