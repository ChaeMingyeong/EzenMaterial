...
<body>
<form action="modifyPro.do" name="modifyForm" method="post">
	<table border="1">
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="id" value="${memberDTO.name}">
			</td>
		</tr>
		<tr>
			<td align="center">비밀번호</td>
			<td><input type="password" name="pwd" size="30"
					value="${memberDTO.pwd} %>"></td>
		</tr>
		<tr>
