...
<div id ="container">
    <div id ="nav">
		<h3><a href="/17-imageboard/main/index.jsp">메인화면</a></h3><br>
		<a href ="#">회원가입</a><br>
		<a href ="#">로그인</a><br>
		<a href ="#">로그아웃</a><br>
		<a href ="#">회원정보수정</a><br>
		<a href ="#">글쓰기</a><br>
		<a href ="/17-imageboard/main/index.jsp?req=imageboardWriteForm">이미지등록</a><br> <!-- 데이터처리없는애는 인데스를 바로보여줌 -->
		<a href ="/17-imageboard/imageboard/imageboardList.jsp?pg=1">이미지목록</a><br> <!-- 데이터처리있는애  -->
	</div>
