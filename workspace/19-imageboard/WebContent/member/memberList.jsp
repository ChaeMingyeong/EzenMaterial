...
<% } %>	
   ...
   <tr>
      ...
      <td colspan="6" align="center">
         <% if(startPage > 1 ) { %>
            [<a href ="../main/index.jsp?req=memberList&pg=<%=startPage-1%>">이전 </a>]   
         <% } %>  
           
          
        <% for(int i=startPage; i<=endPage; i++) { %>
            [<a href ="../main/index.jsp?req=memberList&pg=<%=i%>"> <%=i%> </a>]
       <% } %>
         
         <% if(endPage < totalP ) { %>
            [<a href ="../main/index.jsp?req=memberList&pg=<%=endPage+1%>">다음 </a>]   
         <% } %>  
